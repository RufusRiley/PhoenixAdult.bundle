...
def search(results,encodedTitle,title,searchTitle,siteNum,lang,searchByDateActor,searchDate, searchAll, searchSiteID):
    if searchDate:
        ...
        searchResults = HTML.ElementFromURL('https://tour.trueanal.com/search/' + shortTitle)
        #Log(searchResults.text_content())
        xpathBaseString = '//div[contains(@class,"info-wrap") and contains(div/p/span[contains(@class,"date")],"'+formattedSearchDate+'")]'
        xpathTitleSuffix = 'div/h3[@class="title"]/a/text()'
        xpathLinkSuffix = 'div/h3[@class="title"]/a/@href'
        xpathModelSuffix = 'div/h4[@class="models"]/a/text()'
        xpathDateSuffix = 'div/p/span[@class="date"]/text()'
